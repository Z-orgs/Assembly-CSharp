...
public class Mob : MainObject
{
	...
	public static sbyte[][] idframe;

	public static sbyte[][] idframeAppear;

	public static sbyte[][] idframeDisappear;
	...
	public void update()
	{
		...
		case 1:
			...
			else if (mSystem.currentTimeMillis() - timeStartDie > 1200)
			{
				status = 0;
			}
			break;
