...
public class GameMidlet
{
    ...
    static GameMidlet()
    {
        ...
        java =
            "Tone:localhost:14444:0:0,Bokken:localhost:14444:0:0,Shuriken:localhost:14444:0:0,Tessen:localhost:14444:1:0,Kunai:localhost:14444:0:0,Katana:localhost:14444:0:0,Global-1:52.221.222.194:14444:0:1";
        smartPhone =
            " Z-orgs:146.190.38.197:14444:0:0, localhost:localhost:14444:0:0, :localhost:14444:0:0,  :localhost:14444:1:0,  :localhost:14444:0:0,  :localhost:14444:0:0,Global-1:nj6.teamobi.com:14444:0:1";
    ...
    {
        if (to.Contains("sms://")) to = to.Remove(0, 6);
        _ = Main.isPC;
        GameCanvas.endDlg();
    ...
    public string readFileText(string fileName)
    {
        try
        {
            return new StringReader(((TextAsset)Resources.Load(Main.res + "/" + fileName, typeof(TextAsset))).text).ReadLine();
        }
        catch (IOException)
        {
            return string.Empty;
    ...
    {
        var array = Res.split(str.Trim(), ",", 0);
        ...
        {
            var array2 = Res.split(array[i].Trim(), ":", 0);
    ...
    public static void loadLinkRMS()
    {
        ...
        var dataInputStream = new DataInputStream(array);
    ...
    {
        var result = 0;
        var num = mResources.Lang_VI;
        if (isWorldver) num = mResources.Lang_EN;
