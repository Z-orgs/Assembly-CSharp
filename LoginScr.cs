...
public class LoginScr : mScreen, IActionListener
{
	...
	protected void doLogin()
	{
		...
		isFAQ = false;
		us = tfUser.getText().ToLower().Trim();
		pw = tfPass.getText().ToLower().Trim();
		if (us.Equals("showimei"))
		{
			GameCanvas.startOKDlg("IMEI : " + Main.IMEI);
		}
		else
		{
			if (us == null || pw == null || us.Equals(string.Empty))
			{
				return;
			}
