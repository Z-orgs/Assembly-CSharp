...
{
	public static Image testCapcha;
	...
	public static bool isBallEffect;
	...
	public static bool[] keyPressedz;

	public static bool[] keyReleasedz;
	...
	public static int himgShuriken;
	...
	public static bool isKiemduyet;

	public static bool isKiemduyet_info;

	public static Image imgPlus12;

	public static int secondRemain;

	public static int xKd;

	public static int yKd;
	...
	public static void loadBG(int typeBG)
	{
		...
		int num5 = ((typeBg < 2 || typeBg > 12) ? (2 * GameScr.gH / 3 - gsgreenField2Y) : (2 * GameScr.gH / 3 - bgLayer1y));
		if (num5 < 0)
		{
			num5 = 0;
		}
	...
	public void perform(int idAction, object p)
	{
		...
		case 88821:
		{
			int menuId2 = (int)p;
			ChatPopup.addChatPopup(string.Empty, 1, Char.getMyChar().npcFocus);
			Service.gI().menu(Char.getMyChar().npcFocus.template.npcTemplateId, menuId2, menu.menuSelectedItem);
			break;
		}
		case 88822:
			ChatPopup.addChatPopup(string.Empty, 1, Char.getMyChar().npcFocus);
	...
	static GameCanvas()
	{
		...
		isBallEffect = false;
		isTouch = true;
		keyPressedz = new bool[33];
		keyReleasedz = new bool[33];
		keyHold = new bool[33];
