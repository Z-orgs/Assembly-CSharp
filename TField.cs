...
public class TField : IActionListener
{
	...
	private static readonly int[] MAX_TIME_TO_CONFIRM_KEY;

	private static int CARET_HEIGHT;

	private static readonly int CARET_WIDTH;

	private static readonly int CARET_SHOWING_TIME;

	private static readonly int TEXT_GAP_X;

	private static readonly int MAX_SHOW_CARET_COUNER;

	public static readonly int INPUT_TYPE_ANY;

	public static readonly int INPUT_TYPE_NUMERIC;

	public static readonly int INPUT_TYPE_PASSWORD;

	public static readonly int INPUT_ALPHA_NUMBER_ONLY;
	...
	public static readonly string[] modeNotify;

	public static readonly int NOKIA;

	public static readonly int MOTO;

	public static readonly int ORTHER;

	public static readonly int BB;

	public static int changeModeKey;

	public static readonly sbyte abc;

	public static readonly sbyte Abc;

	public static readonly sbyte ABC;

	public static readonly sbyte number123;
	...
	{
		typeXpeed = 2;
		MAX_TIME_TO_CONFIRM_KEY = new int[7] { 30, 14, 11, 9, 6, 4, 2 };
		CARET_HEIGHT = 0;
		CARET_WIDTH = 1;
		CARET_SHOWING_TIME = 5;
		TEXT_GAP_X = 4;
		MAX_SHOW_CARET_COUNER = 10;
		INPUT_TYPE_ANY = 0;
		INPUT_TYPE_NUMERIC = 1;
		INPUT_TYPE_PASSWORD = 2;
		INPUT_ALPHA_NUMBER_ONLY = 3;
		print = new string[12]
		{
		...
		isQwerty = true;
		mode = 0;
		modeNotify = new string[4] { "abc", "Abc", "ABC", "123" };
		NOKIA = 0;
		MOTO = 1;
		ORTHER = 2;
		BB = 3;
		...
		ABC = 2;
		number123 = 3;
		printDau = "aáàảãạâấầẩẫậăắằẳẵặeéèẻẽẹêếềểễệiíìỉĩịoóòỏõọôốồổỗộơớờởỡợuúùủũụưứừửữựyýỳỷỹỵ";
		BBKEY = new int[17][]
		{
			new int[2] { 32, 48 },
			new int[2] { 49, 69 },
